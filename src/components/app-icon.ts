...
const paths: Record<AppIconName, TemplateResult> = {
  alert: html`<path d="M12 3 2.8 20h18.4L12 3Z"></path><path d="M12 8v5.5M12 17h.01"></path>`,
  bandage: html`<path
  ...
  bars: html`<path d="M4 20V10h4v10M10 20V4h4v16M16 20v-7h4v7M2 20h20"></path>`,
  bulk: html`<path d="M13 2 4 14h7l-1 8 9-12h-7l1-8Z"></path>`,
  check: html`<path d="m5 12 4 4L19 6"></path>`,
  close: html`<path d="m6 6 12 12M18 6 6 18"></path>`,
  cube: html`<path d="m12 2 9 5-9 5-9-5 9-5Z"></path
    ><path d="m3 7 9 5v10l-9-5V7Zm18 0-9 5v10l9-5V7Z"></path>`,
  damage: html`<path d="M4 9.5 12 5l8 4.5v9L12 23l-8-4.5v-9Z"></path
    ><path d="m4 9.5 8 4.5 8-4.5M12 14v9M14 2l-2 3-2-3m6 3-2 3 3 1"></path>`,
  fatality: html`<circle cx="12" cy="7" r="3.5"></circle
    ><path d="M5.5 21v-2.5a6.5 6.5 0 0 1 13 0V21M8.5 12.5l7 7m0-7-7 7"></path>`,
  home: html`<path d="m3 11 9-8 9 8M5.5 9.5V21h13V9.5M9 21v-6h6v6"></path>`,
  info: html`<circle cx="12" cy="12" r="9"></circle><path d="M12 11v6M12 7h.01"></path>`,
  medical: html`<circle cx="12" cy="12" r="9"></circle><path d="M12 7v10M7 12h10"></path>`,
  play: html`<circle cx="12" cy="12" r="9"></circle><path d="m10 8 6 4-6 4V8Z"></path>`,
  settings: html`<circle cx="12" cy="12" r="3"></circle
    ><path
    ...
    ></path>`,
  share: html`<circle cx="18" cy="5" r="2.5"></circle><circle cx="6" cy="12" r="2.5"></circle
    ><circle cx="18" cy="19" r="2.5"></circle><path d="m8.2 10.8 7.5-4.4M8.2 13.2l7.5 4.4"></path>`,
  target: html`<circle cx="12" cy="12" r="9"></circle><circle cx="12" cy="12" r="5"></circle
    ><circle cx="12" cy="12" r="1"></circle>`,
  trophy: html`<path d="M8 3h8v4a4 4 0 0 1-8 0V3Z"></path
